...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Guides, downloads and links by Marcon." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Google+Sans+Code:wght@400;500&family=Roboto:wght@300;400;500;700&display=swap",
      },
      {
        rel: "stylesheet",
